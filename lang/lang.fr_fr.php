...
define("LINK_CAT_SILVER", "/achat/metaux/argent-massif");
...
// Title
define("TITLE_METAL_QUOTES", "Prix des m�taux sp�ciaux (non-ferreux) en France");
...
define("BOTTOMFOOTER", "Metalcash.fr offre le meilleur prix d'achat pour l'�tain, le m�tal argent�, les D3E ainsi que pour le rachat de catalyseurs voiture usag�s.");
...
define("LEGAL_H2_2_TEXT", "E-mail : <a href=\"%s\">via notre formulaire</a> | T�l�phone : %s");
...
define("H2_TITLE_FAQ8_TEXT", "Vous pouvez nous joindre par t�l�phone pendant les heures d'ouvertures au 00 32 474 01 12 93 ou nous �crire directement depuis la page <a href=\"%s\">contactez-nous</a>.");
...
define("H2_TITLE_PIC_TEXT", "Nous pratiquons des tarifs pr�f�rentiels pour les grosses quantit�s. Contactez-nous directement par t�l�phone au 00 32 474 01 12 93 ou via notre <a href=\"%s\">page de contact</a> pour plus de renseignements.");
...
define("H2_TITLE_SEND1_TEXT", "Le co�t de l'envoi varie en fonction du poids et de la ville dans laquelle vous vous trouvez. Veuillez contacter une entreprise de transport pour conna�tre leurs tarifs d'envoi. L'adresse de livraison est 4800 Verviers, Belgique.<p>L'envoi via Mondial Relais (France) co�te:<p><li>Jusqu'� 30 kg: 20 �</li><p>Point Relais: <b>Librairie de Petit-Rechain</b>");
...
// config
define("PHONE_NUMBER", "00 32 474 01 12 93");
...
define("H2_TITLE4_CAT_ETAIN", "Prix de l'�tain en France");
...
define("H2_TITLE5_CAT_MA", "Prix du m�tal argent� en France");
...
define("WARN_QT", "Le prix affich� (500kg) est valable<br> pour tous nos fournisseurs r�guliers.");
...
define("H2_TITLE5_CAT_ETAIN_TEXT", "Nous offrons le meilleur prix pour l'<strong>achat d'�tain au kilo</strong>. Nous achetons dans toute l'Europe et nous effectuons votre paiement par banque le jour de votre livraison. Si vous avez une quantit� d'�tain sup�rieure � 5000kg, n'h�sitez pas � nous contacter pour avoir une offre de prix personnalis�e. Pes�e, analyse et paiement en toute simplicit�. Prix affich� = Prix pay�.");
